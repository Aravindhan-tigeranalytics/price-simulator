...
import {distinct, distinctUntilChanged , map , reduce,filter, tap } from 'rxjs/operators';
...
data = [ [0,this.total_rsv],
        [this.total_nsv, this.total_nsv + this.total_trade_expense],
        [0,this.total_nsv],
        [0,this.total_cogs],
        [this.total_cogs,this.total_cogs + this.total_mars_mac],
        [this.total_cogs + this.total_mars_mac , this.total_cogs + this.total_mars_mac+this.total_retailer_margin],
        ]
        data_new = [ [0,this.total_rsv_new],
        ...
        [this.total_cogs_new + this.total_mars_mac_new , this.total_cogs_new + this.total_mars_mac_new+this.total_retailer_margin_new],
        ]
        // data_perton = [ [0,0.679],
        // [0.407, 0.407 + 0.160],
        // [0,0.407],
...
data_change = [[this.rsv_w_o_vat_$_chg,this.trade_expense_$_chg,this.nsv_$_chg,this.cogs_$_chg,this.mars_mac_$_chg,this.retailer_margin_$_chg],
[this.rsv_w_o_vat_$_chg_percent,this.trade_expense_$_chg_percent,this.nsv_$_chg_percent,this.cogs_$_chg_percent,this.mars_mac_$_chg_percent,this.retailer_margin_$_chg_percent]]; 
chartOptions = this.getChartOption("Base scenario" , this.categories , this.data,"columnrange");
chartOptions_1 = this.getChartOption("New scenario" , this.categories, this.data_new , "columnrange");
...
chartOptionPerTonNew = this.getChartOption("New scenario" , this.categories_perton , this.data_perton,"columnrange");
  ...
  populateFilter(datas){
    of(...datas).pipe(
      distinct((unit:UnitModel)=>unit.category)
      )
      .subscribe(data=>{
       this.categories_filter.push(data.category)
     })
     of(...datas).pipe(
       distinct((unit:UnitModel)=>unit.retailer)
       )
       .subscribe(data=>{
        this.retailer_filter.push(data.retailer)
      })
      of(...datas).pipe(
       distinct((unit:UnitModel)=>unit.product_group)
       )
       .subscribe(data=>{
  ...
  applyFilter(){
   ...
   combineLatest([this.tableData$,this.categoryFilter , this.productFilter , this.retailerFilter]).pipe(
...
// const filteredItems = combineFilters.subscribe();
 ...
 let totalrsv$ =  of(...units).pipe(
     ...
     let total_cogs$ = of(...units).pipe(
      reduce((a, b) => a + parseFloat((b.total_cogs).replace(/,/g, '')), 0)
      )
    ...
    combineLatest([totalrsv$,trade_expense$,total_nsv$,total_cogs$,mars_mac$,retailer_margin$,total_base$,total_weight_in_tons$,
       rsv_vat_new$ , trade_expense_new$,total_nsv_new$,total_cogs_new$,mars_mac_new$,retailer_margin_new$]).subscribe(
      ([totalrsv,tradeexpense,totalnsv,totalcogs,marsmc,retailermargin,totalbase,totalweightintons,rsv_vat_new , trade_expense_new , total_nsv_new,total_cogs_new,mars_mac_new,retailer_margin_new])=>{
        ...
        this.total_weight_in_tons = Math.ceil(totalweightintons /1000000);
        ...
        this.total_retailer_margin_new = Math.ceil(retailer_margin_new /1000000);
        this.rsv_w_o_vat_$_chg = -(this.total_rsv_new - this.total_rsv)
        this.trade_expense_$_chg = -(this.total_trade_expense_new - this.total_trade_expense)
        ...
        this.retailer_margin_$_chg = -(this.total_retailer_margin_new - this.total_retailer_margin)

        this.rsv_w_o_vat_$_chg_percent =(this.rsv_w_o_vat_$_chg / this.total_rsv) * 100
        this.trade_expense_$_chg_percent = (this.trade_expense_$_chg/this.total_trade_expense) * 100
        this.nsv_$_chg_percent = (this.nsv_$_chg/this.total_nsv) * 100
        this.cogs_$_chg_percent = (this.cogs_$_chg / this.total_cogs) * 100
        this.mars_mac_$_chg_percent = (this.mars_mac_$_chg/this.total_mars_mac) * 100
        this.retailer_margin_$_chg_percent = ( this.retailer_margin_$_chg/ this.total_retailer_margin) * 100
  ...
  reRender(){
    this.data = [ [0,this.total_rsv],
        ...
        this.data_perton = [ [0,this.total_rsv/this.total_weight_in_tons],
        [this.total_nsv/this.total_weight_in_tons, this.total_nsv/this.total_weight_in_tons + this.total_trade_expense/this.total_weight_in_tons],
        [0,this.total_nsv/this.total_weight_in_tons],
        [0,this.total_cogs/this.total_weight_in_tons],
        [this.total_cogs/this.total_weight_in_tons,this.total_cogs/this.total_weight_in_tons + this.total_mars_mac/this.total_weight_in_tons],
        [this.total_cogs/this.total_weight_in_tons + this.total_mars_mac/this.total_weight_in_tons , this.total_cogs/this.total_weight_in_tons + this.total_mars_mac/this.total_weight_in_tons+this.total_retailer_margin/this.total_weight_in_tons],
        ]
        this.data_new = [ [0,this.total_rsv_new],
        [this.total_nsv_new, this.total_nsv_new + this.total_trade_expense_new],
        [0,this.total_nsv_new],
        [0,this.total_cogs_new],
        [this.total_cogs_new,this.total_cogs_new + this.total_mars_mac_new],
        ...
        this.data_change = [[this.rsv_w_o_vat_$_chg,this.trade_expense_$_chg,this.nsv_$_chg,this.cogs_$_chg,this.mars_mac_$_chg,this.retailer_margin_$_chg],
[this.rsv_w_o_vat_$_chg_percent,this.trade_expense_$_chg_percent,this.nsv_$_chg_percent,this.cogs_$_chg_percent,this.mars_mac_$_chg_percent,this.retailer_margin_$_chg_percent]];
console.log(this.data_change , "DATA CJANGE")        
this.data_3 = [this.total_base_units , this.total_base_units];
        this.data_2 = [parseFloat(((this.total_mars_mac/this.total_nsv) * 100).toFixed(2)) , parseFloat(((this.total_mars_mac/this.total_nsv) * 100).toFixed(2))];
        this.chartOptions = this.getChartOption("Base scenario" , this.categories , this.data,"columnrange");
this.chartOptions_1 = this.getChartOption("New scenario" , this.categories, this.data_new , "columnrange");
this.chartOptions_4 = this.getChartOptionColumn("Change in Units" , this.categories_3,this.data_3 , "column")
this.chartOptions_2 = this.getChartOptionColumn("Base scenario" , this.categories_2,this.data_2 , "column")
this.chartOptions_3 = this.getChartOptionColumn("New scenario" , this.categories_2,this.data_2 , "column")
this.chartOptionPerTonBase = this.getChartOption("Base scenario" , this.categories_perton , this.data_perton,"columnrange");
this.chartOptionPerTonNew = this.getChartOption("New scenario" , this.categories_perton , this.data_perton,"columnrange");
this.chartOptions_change = this.getChartOptionColumnYaxis("change" , this.category_change,this.data_change , "column")
